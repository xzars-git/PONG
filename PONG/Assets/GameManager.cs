...
public class GameManager : MonoBehaviour
{
    ...
    // Pemain 1
    public Player_Control player1;
    private Rigidbody2D player1Rigidbody;

    // Pemain 2
    public Player_Control player2;
    private Rigidbody2D player2Rigidbody;

    // Bola
    public Ball_Control ball;
    ...
    void OnGUI()
    {
        // Tampilkan skor pemain 1 di kiri atas dan pemain 2 dikanan atas
        ...
        if (GUI.Button(new Rect(Screen.width / 2 - 60, 35, 120, 53), "RESTART"))
        {
            ...
            player2.ResetScore();
            // ... dan restart game
            ball.SendMessage("RestartGame", 0.5f, SendMessageOptions.DontRequireReceiver);
        }
